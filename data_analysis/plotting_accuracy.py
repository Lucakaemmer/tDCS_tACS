...
graph_mean_run(mean_run_measure=mean_run_acc_unshifted, run_error=run_error_acc_uns,
               title="Mean Accuracy comparing the days")
...
graph_mean_run_day(mean_run_measure=mean_run_accuracies, run_error=run_error_acc,
                   title="Mean Accuracy over all 12 runs, layered")

# Plotting a graph of the overall accuracy over the 12 runs with the days laid on top of each other
graph_mean_run_day(mean_run_measure=mean_run_acc_unshifted, run_error=run_error_acc_uns,
                   title="Mean Accuracy comparing the days, layered")

# Plotting a graph of the overall accuracy over the 12 runs with the days laid on top of each other
graph_mean_run_day(mean_run_measure=mean_run_RT, run_error=run_error_RT, title="Mean RT over all 12 runs, layered")
